...
Usage:
    ...
    python evaluation/scripts/run_evaluation.py --t test_data/test.json --o ../../logs/<results_dir> --e evaluation/<eval_results_dir> [--reset] 
    use --reset to start predictions from the beginning
    use --skip-prediction to only run evaluation on existing results
"""
